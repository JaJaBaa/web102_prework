...
// set the innerHTML of the raised card
...
function filterUnfundedOnly() {
  ...
  // Debugging: Log the array to see its length
  console.log(unfundedGames.length);
  return unfundedGames; // Useful for determining the count
}
...
function filterFundedOnly() {
  ...
  return fundedGames; // Useful for determining the count
}
...
const displayStr = `
    A total of $${totalRaised2.toLocaleString()} has been raised for ${
  GAMES_JSON.length
} games. 
...
// Create elements for the top funded games
